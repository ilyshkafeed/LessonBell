insert into `organization` (`id`,`version`,`name`, `full_name`, `inn`, `kpp`, `address`, `phone`, `is_active`) values
  (1, 0, 'Shanahan',  'Shanahan LLC',     '2303924823', '507516285', '05924 Parkside Plaza',    '+670 (444) 123-9624',  1),
  (2, 0, 'HP',        'Heathcote-Price',  '7956748358', '208752490', '19885 Southridge Plaza',  '+358 (811) 283-7427',  1),
  (3, 0, 'BL',        'Beer-Legros',      '4429499323', '141146610', '73 Artisan Point',        '+63 (178) 446-7799',   1);


insert into `office` (`id`,`version`,`organization_id`, `name`, `address`, `phone`, `is_active`,) values
  (1, 0, 1,  'Главный',        '05924 Parkside Plaza',    '+670 (444) 123-9624',  1),
  (2, 0, 1,  'Нижегородский',  '19885 Southridge Plaza',  '+358 (811) 283-7427',  1),
  (3, 0, 2,  'Главный',        '73 Artisan Point',        '+63 (178) 446-7799',   1);
